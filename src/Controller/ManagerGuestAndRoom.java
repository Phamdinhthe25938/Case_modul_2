...
//            Enter address:
    ...
    public void roomPayment(){
        while (true){
            System.out.println("Nhập CCCD mà bạn: ");
            ...
            if(validateGustAndStaff.checkIdExist(idPersonPayment,gustsList)>=0){
                ...
                System.out.println("Thực hiện thanh toán thành công!!!!");
    ...
    public void ReprintTheInvoice(){
        int vtNumberSeri = validateGustAndStaff.validateNumberSeri(postageList);
    ...
    public void editRoom(){
        ...
        int vtCodeRoomEdit = validateRoom.validateCodeRoom(roomList);
        roomList.remove(vtCodeRoomEdit);
