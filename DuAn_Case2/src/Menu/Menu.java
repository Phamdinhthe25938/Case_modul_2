...
public class Menu {
    ...
    public void menuGust() {
        while (true) {
            ...
            System.out.println("6.Tìm lại hóa đơn !");
            System.out.println("7.Tổng doanh thu trong ngày !");
                    ...
                    choiceGust = Integer.parseInt(sc.nextLine());
                            switch (choiceGust) {
                                ...
                                case 5:
                                    ...
                                    break;
                                case 6:
                                    managerGuestAndRoom.ReprintTheInvoice();
                                    break;
                                case 7:
                                    managerGuestAndRoom.totalRevenue();
                                    break;
                            }
                    if(choiceGust<0 || choiceGust >7) {
    ...
    public void menu(String nameAccount){
        ...
        while(true){
            ...
            boolean equals = nameAccount.trim().equals(nameAccountManager.trim());
            if(equals){
